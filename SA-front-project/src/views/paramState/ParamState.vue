            ...
            <el-row v-for="(param,index) in selectedParams"
              ...
              <el-row>
                <el-table :data="param.table" border style="width: 100%">
                  ...
                  <el-table-column label="Left-Bounded">
                    <template slot-scope="scope">
                      <el-input class="model-input" size="small" v-model="scope.row.left" />
                    </template>
                  </el-table-column>
                  <el-table-column label="Right-Bounded">
                    <template slot-scope="scope">
                      <el-input class="model-input" size="small" v-model="scope.row.right" />
                    </template>
                  </el-table-column>
...
export default {
  ...
  methods:{
    ...
    confirmParams(){
      ...
      console.log(this.selectedIDs, this.selectedParams)
